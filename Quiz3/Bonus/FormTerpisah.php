...
<body>
    ...
    <form method="POST" action="">
        <label for="inama">Masukkan Nama:</label><br>
        <input type="text" id="inama" name="inama"><br><br>
        <label for="iumur">Masukkan Umur:</label><br>
        <input type="text" id="iumur" name="iumur"><br><br>
        <label for="ikota">Masukkan Kota:</label><br>
        <input type="text" id="ikota" name="ikota"><br><br>
